...
$.ajax({
   url: "../json/commdity.json",//json文件位置
   type: "GET",//请求方式为get
...
u.appendChild(li);
li.innerHTML = `<a href="../shop/shop.html">
							<img src="${item.img}"/>
							...
							<div class="article-6"><img src="../images/19.png"/></div>	
							</a>`;
       })
...
var oul=document.querySelector("#main>.main>article>.article-3>ul")
...
var index = $(target.parentNode.parentNode).index()-1;
console.log(index);
setCookie("id",index,{path:"/"});
}
})
